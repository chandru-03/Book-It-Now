...
function DanceSeatSelector({event}) {
        ...
        console.log('Evnet Price',event.price[0]); ;
        

        const  handleNavigation = () => {
            if(event.price[0] === 0) {
                navigate('/', { state: { item: event } })
            } else{
                navigate('/ticketoptions', {state: {event: event, price: price, seatCount: seatLength, seatings:seatings}})
            }
...
export default DanceSeatSelector